...
<head>
    ...
    <style>
        ...
        .content-container {
            ...
            border-radius: 10px;
            margin-top: 70px;
            width: 95%; /* Using percentage width for better responsiveness */
        }
        .highlight {
            color: #e53e3e;
            font-weight: bold;
        ...
        .styled-paragraph {
            line-height: 1.8;
            font-size: 1.08rem; /* Increased from 1.05rem */
        ...
        .section-title {
            ...
            margin-bottom: 20px;
            text-align: center;
            font-size: 1.15em; /* Slightly increased font size */
        }
        .section-title:after {
            content: '';
            position: absolute;
        ...
        .section-header {
            ...
            text-align: center;
            margin-bottom: 30px;
            padding-top: 40px; /* Added more padding above */
            background: linear-gradient(45deg, #ff5e62, #ff9966);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        ...
        @media (max-width: 992px) {
            .member-card { width: 200px; }
            .section-container { padding: 30px 25px; }
        }
        @media (max-width: 768px) {
            .member-card-container { gap: 15px; }
            .member-card { 
                width: calc(50% - 15px);
                max-width: 180px;
            }
            ...
            .styled-paragraph { font-size: 1rem; }
        ...
        @media (max-width: 576px) {
            ...
            .member-card h3 { font-size: 1em; }
            .member-card p { font-size: 0.8em; }
            .styled-paragraph { font-size: 0.95rem; }
        ...
        <div class="section-container">
            ...
            $sections = [
                ...
                /*    ['name' => 'Mr. U. S. Mukherjee', 'role' => 'Dy. Director, JIS Group', 'image' => '#', 'social' => ['twitter' => '#', 'facebook' => '#', 'instagram' => '#', 'linkedin' => '#']], */
                    ['name' => 'Mr. Debashis Sanki', 'role' => 'Dy. Registrar, JIS College of Engineering', 'image' => 'https://i.postimg.cc/6pSvZdDR/Debasish-Sanki.jpg', 'social' => ['twitter' => '#', 'facebook' => '#', 'instagram' => '#', 'linkedin' => '#']],
                ],
                'Convener' => [
                ...
                'Cultural Team' => [
                    ...
                    ['name' => ' ', 'role' => 'Anchoring and Recitation, 3rd YR, CST', 'image' => '#', 'social' => ['twitter' => '#', 'facebook' => '#', 'instagram' => '#', 'linkedin' => '#']],
